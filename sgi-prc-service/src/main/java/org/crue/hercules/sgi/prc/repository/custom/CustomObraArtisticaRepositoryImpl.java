...
public class CustomObraArtisticaRepositoryImpl implements CustomObraArtisticaRepository {
  ...
  public Page<ObraArtisticaResumen> findAllObrasArtisticas(Specification<ProduccionCientifica> specs,
      Pageable pageable) {
    log.debug("findAllObrasArtisticas(Specification<ProduccionCientifica> specs, Pageable pageable) - start");
    ...
    listPredicates.add(cb.equal(root.get(ProduccionCientifica_.epigrafeCVN), EpigrafeCVN.E050_020_030_000));
    ...
    listPredicates.add(cb.equal(rootCount.get(ProduccionCientifica_.epigrafeCVN), EpigrafeCVN.E050_020_030_000));
    ...
    log.debug("findAllObrasArtisticas(Specification<ProduccionCientifica> specs, Pageable pageable) - end");
