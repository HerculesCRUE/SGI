...
/**
 * Servicio para la baremación de costes indirectos de proyectos
 */
@Service
@Transactional(readOnly = true)
@Validated
public class BaremacionCosteIndirectoProyectoService extends BaremacionCosteIndirectoService {

  @Autowired
  public BaremacionCosteIndirectoProyectoService(
  ...
  protected CodigoCVN getCodigoCVNCuantiaCostesIndirectos() {
    return CodigoCVN.CUANTIA_COSTES_INDIRECTOS_PROYECTO;
  }

  protected EpigrafeCVN getEpigrafeCVNCostesIndirectos() {
    return EpigrafeCVN.E050_020_010_000;
  }
}
