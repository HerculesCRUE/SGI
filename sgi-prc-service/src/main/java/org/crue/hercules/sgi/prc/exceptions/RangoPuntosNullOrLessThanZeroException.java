...
public class RangoPuntosNullOrLessThanZeroException extends ProblemException {
  public static final URI CUSTOM_PROBLEM_TYPE = URI.create("urn:problem-type:validation");

  public RangoPuntosNullOrLessThanZeroException() {
    super(Problem.builder().type(CUSTOM_PROBLEM_TYPE)
        .title(ProblemMessage.builder().key(HttpStatus.class, "BAD_REQUEST").build())
        .detail(ProblemMessage.builder().key(RangoPuntosNullOrLessThanZeroException.class).build())
