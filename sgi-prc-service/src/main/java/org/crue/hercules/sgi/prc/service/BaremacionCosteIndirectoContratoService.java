...
/**
 * Servicio para la baremación de costes indirectos de contratos
 */
@Service
@Transactional(readOnly = true)
public class BaremacionCosteIndirectoContratoService extends BaremacionCosteIndirectoService {

  @Autowired
  public BaremacionCosteIndirectoContratoService(
    ...
    super(aliasEnumeradoRepository,
        ...
        modelMapper,
        sgiConfigProperties,
        configuracionCampoRepository,
        rangoRepository);
  }

  protected CodigoCVN getCodigoCVNCuantiaCostesIndirectos() {
    return CodigoCVN.CUANTIA_COSTES_INDIRECTOS_CONTRATO;
  }

  protected EpigrafeCVN getEpigrafeCVNCostesIndirectos() {
    return EpigrafeCVN.E050_020_020_000;
  }
}
