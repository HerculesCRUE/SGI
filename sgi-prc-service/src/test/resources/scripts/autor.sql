...
INSERT INTO test.autor (id, produccion_cientifica_id, orcid_id, orden, firma, persona_ref, nombre, apellidos, fecha_inicio, fecha_fin) VALUES(2, 1, 'orcid_id2', 2, NULL, 'persona_ref1', NULL, NULL, NULL, NULL);
...
INSERT INTO test.autor (id, produccion_cientifica_id, orcid_id, orden, firma, persona_ref, nombre, apellidos, fecha_inicio, fecha_fin) VALUES(4, 2, 'orcid_id2_1', 1, NULL, 'persona_ref2_1', NULL, NULL, NULL, NULL);
INSERT INTO test.autor (id, produccion_cientifica_id, orcid_id, orden, firma, persona_ref, nombre, apellidos, fecha_inicio, fecha_fin) VALUES(5, 2, 'orcid_id2_2', 2, NULL, 'persona_ref2_2', NULL, NULL, NULL, NULL);
INSERT INTO test.autor (id, produccion_cientifica_id, orcid_id, orden, firma, persona_ref, nombre, apellidos, fecha_inicio, fecha_fin) VALUES(6, 2, 'orcid_id2_3', 3, NULL, 'persona_ref2_3', NULL, NULL, NULL, NULL);
