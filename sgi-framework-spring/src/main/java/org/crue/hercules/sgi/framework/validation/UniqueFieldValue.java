...
public @interface UniqueFieldValue {
   ...
   */
  String message() default "{org.crue.hercules.sgi.framework.validation.UnikeFieldValue.message}";
  ...
  /**
   * The entity field name whose value must be unique in the database.
   * 
