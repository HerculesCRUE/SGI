...
public class EmpresaComposicionSociedadIT extends BaseIT {

  private static final String PATH_PARAMETER_ID = "/{id}";
  private static final String CONTROLLER_BASE_PATH = "/empresascomposicionessociedades";

  private HttpEntity<EmpresaComposicionSociedad> buildRequest(HttpHeaders headers, EmpresaComposicionSociedad entity)
      throws Exception {
    ...
    HttpEntity<EmpresaComposicionSociedad> request = new HttpEntity<>(entity, headers);
    return request;
  }
  ...
  @Test
  public void findById_ReturnsEmpresaComposicionSociedad() throws Exception {
    Long id = 1L;
    ...
    final ResponseEntity<EmpresaComposicionSociedadOutput> response = restTemplate.exchange(
        ...
        HttpMethod.GET, buildRequest(null, null), EmpresaComposicionSociedadOutput.class, id);
