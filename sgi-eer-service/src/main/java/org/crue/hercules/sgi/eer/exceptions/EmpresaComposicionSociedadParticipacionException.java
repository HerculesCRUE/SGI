...
public class EmpresaComposicionSociedadParticipacionException extends ProblemException {
  public static final URI CUSTOM_PROBLEM_TYPE = URI.create("urn:problem-type:validation");

  public EmpresaComposicionSociedadParticipacionException() {
    super(Problem.builder().type(CUSTOM_PROBLEM_TYPE)
        ...
        .detail(ProblemMessage.builder().key(EmpresaComposicionSociedadParticipacionException.class).build())
