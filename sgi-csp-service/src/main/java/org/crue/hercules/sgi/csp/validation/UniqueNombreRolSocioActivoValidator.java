...
public class UniqueNombreRolSocioActivoValidator
    implements ConstraintValidator<UniqueNombreRolSocioActivo, RolSocio> {

  private RolSocioRepository repository;
  private String field;

  public UniqueNombreRolSocioActivoValidator(RolSocioRepository repository) {
    this.repository = repository;
  }

  @Override
  public void initialize(UniqueNombreRolSocioActivo constraintAnnotation) {
