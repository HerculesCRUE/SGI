...
public class ColaborativoWithoutCoordinadorExternoException extends ProblemException {
  public static final URI CUSTOM_PROBLEM_TYPE = URI.create("urn:problem-type:validation");

  public ColaborativoWithoutCoordinadorExternoException() {
    super(Problem.builder().type(CUSTOM_PROBLEM_TYPE)
        ...
        .detail(ProblemMessage.builder().key(
            ColaborativoWithoutCoordinadorExternoException.class).build())
