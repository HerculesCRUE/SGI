...
public interface RequisitoIPNivelAcademicoRepository
    extends JpaRepository<RequisitoIPNivelAcademico, Long>, JpaSpecificationExecutor<RequisitoIPNivelAcademico> {
