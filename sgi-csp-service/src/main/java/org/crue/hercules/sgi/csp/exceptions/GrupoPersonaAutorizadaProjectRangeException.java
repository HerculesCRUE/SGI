...
public class GrupoPersonaAutorizadaProjectRangeException extends ProblemException {
  ...
  public GrupoPersonaAutorizadaProjectRangeException(Instant min, Instant max) {
    super(Problem.builder().type(CUSTOM_PROBLEM_TYPE)
        .title(ProblemMessage.builder().key(HttpStatus.class, "BAD_REQUEST").build())
        .detail(ProblemMessage.builder().key(GrupoPersonaAutorizadaProjectRangeException.class)
