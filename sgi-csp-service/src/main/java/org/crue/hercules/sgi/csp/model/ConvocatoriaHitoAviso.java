...
@Entity
@Table(name = "convocatoria_hito_aviso")
@Data
...
public class ConvocatoriaHitoAviso extends BaseEntity {
  ...
  @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "convocatoria_hito_aviso_seq")
  @SequenceGenerator(name = "convocatoria_hito_aviso_seq", sequenceName = "convocatoria_hito_aviso_seq", allocationSize = 1)
  private Long id;
  ...
  @OneToOne(mappedBy = "convocatoriaHitoAviso")
  @Getter(AccessLevel.NONE)
  @Setter(AccessLevel.NONE)
  private final ConvocatoriaHito convocatoriaHito = null;
}
