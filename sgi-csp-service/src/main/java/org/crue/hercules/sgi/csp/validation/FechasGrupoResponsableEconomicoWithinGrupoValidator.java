...
public class FechasGrupoResponsableEconomicoWithinGrupoValidator
    implements ConstraintValidator<FechasGrupoResponsableEconomicoWithinGrupo, GrupoResponsableEconomico> {

  private final GrupoRepository repository;

  public FechasGrupoResponsableEconomicoWithinGrupoValidator(GrupoRepository repository) {
    this.repository = repository;
  }

  @Override
  public boolean isValid(GrupoResponsableEconomico value, ConstraintValidatorContext context) {
