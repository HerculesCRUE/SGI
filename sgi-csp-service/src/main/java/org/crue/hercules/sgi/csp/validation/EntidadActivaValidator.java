...
import org.crue.hercules.sgi.csp.repository.ActivableRepository;
    ...
    if (repositoryClass == void.class) {
      try {
        repositoryClass = Class
            .forName("org.crue.hercules.sgi.csp.repository.".concat(entityClass.getSimpleName()).concat("Repository"));
