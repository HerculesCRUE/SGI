...
public class UserNotAuthorizedToAccessAutorizacionException extends ProblemException {
  public static final URI CUSTOM_PROBLEM_TYPE = URI.create("urn:problem-type:validation");

  public UserNotAuthorizedToAccessAutorizacionException() {
    super(Problem.builder().type(CUSTOM_PROBLEM_TYPE)
        ...
        .detail(ProblemMessage.builder().key(
            UserNotAuthorizedToAccessAutorizacionException.class).build())
