...
public class ProyectoSocioPeriodoJustificacionIT extends BaseIT {

  private static final String PATH_PARAMETER_ID = "/{id}";
  private static final String CONTROLLER_BASE_PATH = "/proyectosocioperiodojustificaciones";

  private HttpEntity<ProyectoSocioPeriodoJustificacion> buildRequest(HttpHeaders headers,
      ProyectoSocioPeriodoJustificacion entity) throws Exception {
    headers = (headers != null ? headers : new HttpHeaders());
    headers.setContentType(MediaType.APPLICATION_JSON);
    headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
    headers.set("Authorization", String.format("bearer %s", tokenBuilder.buildToken("user", "CSP-PRO-E")));

    HttpEntity<ProyectoSocioPeriodoJustificacion> request = new HttpEntity<>(entity, headers);
    return request;
  }
  ...
  @Sql(executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD, scripts = "classpath:cleanup.sql")
  @Test
  public void update_ReturnsProyectoSocioPeriodoJustificacion() throws Exception {
  ...
  @Sql(executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD, scripts = "classpath:cleanup.sql")
  @Test
  public void findById_ReturnsProyectoSocioPeriodoJustificacion() throws Exception {
