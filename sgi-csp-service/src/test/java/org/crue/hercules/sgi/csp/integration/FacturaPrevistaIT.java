...
import org.crue.hercules.sgi.csp.controller.FacturaPrevistaController;
...
class FacturaPrevistaIT extends BaseIT {
  ...
  @Test
  void findAll_WithPagingSortingAndFiltering_ReturnsFacturaEmitidaOutputList() throws Exception {
    ...
    final List<FacturaEmitidaOutput> responseData = response.getBody();
  ...
  void findAll_WithPagingSortingAndFiltering_ReturnsNoContentStatus() throws Exception {
    ...
    headers.add("X-Page-Size", "3");
    String sort = "id,asc";
    String filter = "proyectoIdSGI==30";
