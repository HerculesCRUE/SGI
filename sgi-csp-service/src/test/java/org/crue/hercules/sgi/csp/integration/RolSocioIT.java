...
class RolSocioIT extends BaseIT {
  ...
  @Test
  void findById_ReturnsRolSocio() throws Exception {
    Long id = 1L;
  ...
  @Sql(executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD, scripts = "classpath:cleanup.sql")
  @Test
  void findAll_WithPagingSortingAndFiltering_ReturnsRolSocioSubList() throws Exception {
