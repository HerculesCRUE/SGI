...
INSERT INTO test.area_tematica (id, nombre, descripcion, area_tematica_padre_id, activo) VALUES (2, 'nombre-002', 'descripcion-002', null, true);
INSERT INTO test.area_tematica (id, nombre, descripcion, area_tematica_padre_id, activo) VALUES (3, 'nombre-003', 'descripcion-003', null, true);
INSERT INTO test.area_tematica (id, nombre, descripcion, area_tematica_padre_id, activo) VALUES (4, 'nombre-004', 'descripcion-004', null, true);
INSERT INTO test.area_tematica (id, nombre, descripcion, area_tematica_padre_id, activo) VALUES (5, 'nombre-005', 'descripcion-005', null, true);
INSERT INTO test.area_tematica (id, nombre, descripcion, area_tematica_padre_id, activo) VALUES (6, 'nombre-006', 'descripcion-006', null, true);
...
INSERT INTO test.convocatoria_area_tematica (id, convocatoria_id, area_tematica_id, observaciones) VALUES (3, 1, 3, 'observaciones-003');
INSERT INTO test.convocatoria_area_tematica (id, convocatoria_id, area_tematica_id, observaciones) VALUES (4, 1, 4, 'observaciones-4');
INSERT INTO test.convocatoria_area_tematica (id, convocatoria_id, area_tematica_id, observaciones) VALUES (5, 2, 5, 'observaciones-001');
INSERT INTO test.convocatoria_area_tematica (id, convocatoria_id, area_tematica_id, observaciones) VALUES (6, 2, 6, 'observaciones-002');