...
--CONCEPTO GASTO
INSERT INTO csp.concepto_gasto (id,nombre,descripcion,activo) VALUES (1,'nombre-1','descripcion-1',true);
INSERT INTO csp.concepto_gasto (id,nombre,descripcion,activo) VALUES (2,'nombre-2','descripcion-1',true);
INSERT INTO csp.concepto_gasto (id,nombre,descripcion,activo) VALUES (3,'nombre-3','descripcion-1',true);

--CONVOCATORIA CONCEPTO GASTO
INSERT INTO  csp.convocatoria_concepto_gasto(id, convocatoria_id, concepto_gasto_id, observaciones,permitido) VALUES (1, 1, 1,'obs-001', true);
INSERT INTO  csp.convocatoria_concepto_gasto(id, convocatoria_id, concepto_gasto_id, observaciones,permitido) VALUES (2, 1, 2,'obs-002', true);
INSERT INTO  csp.convocatoria_concepto_gasto(id, convocatoria_id, concepto_gasto_id, observaciones,permitido) VALUES (3, 1, 3,'obs-003', true);
INSERT INTO  csp.convocatoria_concepto_gasto(id, convocatoria_id, concepto_gasto_id, observaciones,permitido) VALUES (4, 1, 1,'obs-004', false);
INSERT INTO  csp.convocatoria_concepto_gasto(id, convocatoria_id, concepto_gasto_id, observaciones,permitido) VALUES (5, 1, 2,'obs-005', false);
INSERT INTO  csp.convocatoria_concepto_gasto(id, convocatoria_id, concepto_gasto_id, observaciones,permitido) VALUES (6, 1, 3,'obs-006', false);
