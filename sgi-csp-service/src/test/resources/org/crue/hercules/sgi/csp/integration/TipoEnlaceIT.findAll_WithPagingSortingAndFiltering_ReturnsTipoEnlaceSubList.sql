...
insert into csp.tipo_enlace (id,nombre,descripcion,activo) values (5,'nombre-011','descripcion-011',true);
insert into csp.tipo_enlace (id,nombre,descripcion,activo) values (6,'nombre-012','descripcion-012',true);
insert into csp.tipo_enlace (id,nombre,descripcion,activo) values (7,'nombre-013','descripcion-013',false);