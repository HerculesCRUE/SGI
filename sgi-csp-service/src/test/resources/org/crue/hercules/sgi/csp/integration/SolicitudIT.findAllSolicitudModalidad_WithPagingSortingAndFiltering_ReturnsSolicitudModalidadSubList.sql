...
INSERT INTO test.convocatoria_entidad_convocante (id,  convocatoria_id, entidad_ref, programa_id) VALUES (2, 1, 'entidad-002', 2);
INSERT INTO test.convocatoria_entidad_convocante (id,  convocatoria_id, entidad_ref, programa_id) VALUES (3, 1, 'entidad-003', 3);
INSERT INTO test.convocatoria_entidad_convocante (id,  convocatoria_id, entidad_ref, programa_id) VALUES (4, 1, 'entidad-014', 1);
...
INSERT INTO test.solicitud (id,titulo, codigo_externo, codigo_registro_interno, estado_solicitud_id, convocatoria_id, creador_ref, solicitante_ref, observaciones, convocatoria_externa, unidad_gestion_ref, formulario_solicitud, activo)
 VALUES (2, 'titulo',null, 'SGI_SLC2202011061027', null, 1, 'usr-002', 'usr-003', 'observaciones 2', null, '2', 'PROYECTO', true);
...
INSERT INTO test.solicitud_modalidad (id, solicitud_id, entidad_ref, programa_id) VALUES (2, 1, 'entidad-002', 2);
INSERT INTO test.solicitud_modalidad (id, solicitud_id, entidad_ref, programa_id) VALUES (3, 1, 'entidad-003', 3);
INSERT INTO test.solicitud_modalidad (id, solicitud_id, entidad_ref, programa_id) VALUES (4, 1, 'entidad-014', 2);
INSERT INTO test.solicitud_modalidad (id, solicitud_id, entidad_ref, programa_id) VALUES (5, 2, 'entidad-001', 3);