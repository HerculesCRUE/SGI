...
INSERT INTO test.proyecto_socio_periodo_justificacion_documento (id, proyecto_socio_periodo_justificacion_id, nombre,  documento_ref, tipo_documento_id, comentario, visible)
