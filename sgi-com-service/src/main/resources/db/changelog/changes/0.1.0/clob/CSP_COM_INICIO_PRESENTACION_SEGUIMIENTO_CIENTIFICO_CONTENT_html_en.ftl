...
<html>
  ...
  <body>
    <p>In the month of <b>${data.fecha?date.iso?string.MMMM}</b> of <b>${data.fecha?date.iso?string.yyyy}</b>, the period for submitting the justification of scientific monitoring for the following projects begins:</p>
