...
export class SelectNivelesAcademicosTypeComponent extends FieldType {
  ...
  constructor(
    ...
    private readonly nivelAcademicoService: NivelAcademicosService
  ) {
    super();
    ...
    this.nivelesAcademicos$ = this.nivelAcademicoService.findAll(findOptions).pipe(
