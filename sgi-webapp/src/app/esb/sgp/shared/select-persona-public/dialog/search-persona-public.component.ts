...
@Component({
  templateUrl: './search-persona-public.component.html',
  styleUrls: ['./search-persona-public.component.scss']
})
export class SearchPersonaPublicModalComponent extends DialogCommonComponent implements OnInit, AfterViewInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<SearchPersonaPublicModalComponent>,
    @Inject(MAT_DIALOG_DATA) public data: SearchPersonaModalData,
    private personaService: PersonaPublicService,
