...
export enum TipoClasificacionPublic {
  SECTORES_INDUSTRIALES = 'SECTORES_INDUSTRIALES',
  AREAS_ANEP = 'ANEP'
}

export interface ClasificacionPublicModalData {
  selectedClasificaciones: IClasificacion[];
  tipoClasificacion?: TipoClasificacionPublic;
  multiSelect: boolean;
}
...
@Component({
  templateUrl: './clasificacion-public-modal.component.html',
  styleUrls: ['./clasificacion-public-modal.component.scss']
})
export class ClasificacionPublicModalComponent extends DialogFormComponent<ClasificacionListado[]> implements OnInit {
  ...
  constructor(
    matDialogRef: MatDialogRef<ClasificacionPublicModalComponent>,
    @Inject(MAT_DIALOG_DATA) public data: ClasificacionPublicModalData,
