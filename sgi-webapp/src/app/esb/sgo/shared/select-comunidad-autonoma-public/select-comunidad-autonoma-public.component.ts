...
import { ComunidadAutonomaPublicService } from '@core/services/sgo/comunidad-autonoma/comunidad-autonoma-public.service';
import { Observable, of } from 'rxjs';
import { map, tap } from 'rxjs/operators';

@Component({
  selector: 'sgi-select-comunidad-autonoma-public[paisRef]',
  ...
  providers: [
    {
      ...
      useExisting: SelectComunidadAutonomaPublicComponent
    }
  ]
})
export class SelectComunidadAutonomaPublicComponent extends SelectServiceComponent<IComunidadAutonoma> {
  ...
  constructor(
    ...
    private comunidadAutonomaService: ComunidadAutonomaPublicService
  ) {
