...
@Component({
  template: `
    ...
    >
      <ng-container *ngIf="paises$ | formlySelectOptions: field | async as selectOptions">
...
export class SelectPaisesPublicTypeComponent extends FieldType {
  defaultOptions = {
    templateOptions: {
      options: [],
  ...
  paises$: Observable<IPais[]> = of([]);

  constructor(
    private readonly logger: NGXLogger,
    protected readonly snackBarService: SnackBarService,
    private readonly paisService: PaisPublicService
  ) {
    super();
    ...
    this.paises$ = this.paisService.findAll(findOptions).pipe(
