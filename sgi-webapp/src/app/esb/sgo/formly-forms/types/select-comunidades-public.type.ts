...
export class SelectComunidadesPublicTypeComponent extends FieldType implements OnInit {
  defaultOptions = {
    templateOptions: {
      options: [],
  ...
  constructor(
    ...
    private readonly comunidadAutonomaService: ComunidadAutonomaPublicService
  ) {
    super();
  }
