  ...
  providers: [
    {
      ...
      useExisting: ResourceUploadComponent
    }
  ],
})
export class ResourceUploadComponent implements
  OnDestroy, OnInit, DoCheck, ControlValueAccessor,
  MatFormFieldControl<IDocumento> {

  /** Unique id for this input. */
  private uid = `sgi-resource-upload-${nextUniqueId++}`;
  ...
  controlType = 'sgi-resource-upload';
