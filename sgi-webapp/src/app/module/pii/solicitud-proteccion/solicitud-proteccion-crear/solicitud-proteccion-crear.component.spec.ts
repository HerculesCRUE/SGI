...
import { SolicitudProteccionCrearComponent } from './solicitud-proteccion-crear.component';

describe('SolicitudProteccionCrearComponent', () => {
  let component: SolicitudProteccionCrearComponent;
  let fixture: ComponentFixture<SolicitudProteccionCrearComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(SolicitudProteccionCrearComponent);
