...
import { TesisTfmTfgEditarComponent } from './tesis-tfm-tfg-editar.component';

describe('TesisTfmTfgEditarComponent', () => {
  let component: TesisTfmTfgEditarComponent;
  let fixture: ComponentFixture<TesisTfmTfgEditarComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(TesisTfmTfgEditarComponent);
