...
@Component({
  selector: 'sgi-tesis-tfm-tfg-editar',
  templateUrl: './tesis-tfm-tfg-editar.component.html',
  styleUrls: ['./tesis-tfm-tfg-editar.component.scss'],
  viewProviders: [
    TesisTfmTfgActionService
  ]
})
export class TesisTfmTfgEditarComponent extends ActionComponent implements OnInit {

  TESIS_TFM_TFG_ROUTE_NAMES = TESIS_TFM_TFG_ROUTE_NAMES;
