...
import { ActividadIdiDatosGeneralesFragment } from './actividad-idi-datos-generales.fragment';

const MSG_DOWNLOAD_ERROR = marker('error.file.download');

@Component({
  selector: 'sgi-actividad-idi-datos-generales',
  templateUrl: './actividad-idi-datos-generales.component.html',
  styleUrls: ['./actividad-idi-datos-generales.component.scss']
})
export class ActividadIdiDatosGeneralesComponent extends FragmentComponent implements OnInit, OnDestroy {

  fxLayoutProperties: FxLayoutProperties;
  formPart: ActividadIdiDatosGeneralesFragment;
