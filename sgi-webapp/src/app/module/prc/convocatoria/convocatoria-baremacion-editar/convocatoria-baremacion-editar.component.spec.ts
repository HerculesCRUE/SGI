...
import { ConvocatoriaBaremacionEditarComponent } from './convocatoria-baremacion-editar.component';

describe('ConvocatoriaBaremacionEditarComponent', () => {
  let component: ConvocatoriaBaremacionEditarComponent;
  let fixture: ComponentFixture<ConvocatoriaBaremacionEditarComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ConvocatoriaBaremacionEditarComponent);
