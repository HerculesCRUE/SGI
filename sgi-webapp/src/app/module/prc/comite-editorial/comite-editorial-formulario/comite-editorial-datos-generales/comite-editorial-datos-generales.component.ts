...
@Component({
  selector: 'sgi-comite-editorial-datos-generales',
  templateUrl: './comite-editorial-datos-generales.component.html',
  styleUrls: ['./comite-editorial-datos-generales.component.scss']
})
export class ComiteEditorialDatosGeneralesComponent extends FragmentComponent implements OnInit, OnDestroy {
  fxLayoutProperties: FxLayoutProperties;
  formPart: ComiteEditorialDatosGeneralesFragment;
