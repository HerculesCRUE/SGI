...
import { ObraArtisticaDatosGeneralesFragment } from './obra-artistica-formulario/obra-artistica-datos-generales/obra-artistica-datos-generales.fragment';

@Injectable()
export class ObraArtisticaActionService extends ActionService {
  ...
  private datosGenerales: ObraArtisticaDatosGeneralesFragment;
  ...
  constructor(
    ...
    if (this.id) {
      ...
      this.datosGenerales = new ObraArtisticaDatosGeneralesFragment(
