...
@Component({
  selector: 'sgi-obra-artistica-editar',
  templateUrl: './obra-artistica-editar.component.html',
  styleUrls: ['./obra-artistica-editar.component.scss'],
  viewProviders: [
    ObraArtisticaActionService
  ]
})
export class ObraArtisticaEditarComponent extends ActionComponent implements OnInit {

  OBRA_ARTISTICA_ROUTE_NAMES = OBRA_ARTISTICA_ROUTE_NAMES;
