...
import { ObraArtisticaDatosGeneralesComponent } from './obra-artistica-datos-generales.component';

describe('ObraArtisticaDatosGeneralesComponent', () => {
  let component: ObraArtisticaDatosGeneralesComponent;
  let fixture: ComponentFixture<ObraArtisticaDatosGeneralesComponent>;
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      declarations: [
        ObraArtisticaDatosGeneralesComponent
      ],
      imports: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ObraArtisticaDatosGeneralesComponent);
