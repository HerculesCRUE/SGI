...
import { PublicacionEditarComponent } from './publicacion-editar.component';

describe('PublicacionEditarComponent', () => {
  let component: PublicacionEditarComponent;
  let fixture: ComponentFixture<PublicacionEditarComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(PublicacionEditarComponent);
