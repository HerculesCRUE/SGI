...
import { PublicacionDatosGeneralesFragment } from './publicacion-datos-generales.fragment';

const MSG_DOWNLOAD_ERROR = marker('error.file.download');

@Component({
  selector: 'sgi-publicacion-datos-generales',
  templateUrl: './publicacion-datos-generales.component.html',
  styleUrls: ['./publicacion-datos-generales.component.scss']
})
export class PublicacionDatosGeneralesComponent extends FragmentComponent implements OnInit, OnDestroy {
  fxLayoutProperties: FxLayoutProperties;
  formPart: PublicacionDatosGeneralesFragment;
  private subscriptions: Subscription[] = [];

  indiceImpactoDataSource = new MatTableDataSource<IIndiceImpacto>();
  displayedColumnsIndiceImpacto = ['fuente-impacto', 'anio', 'valor', 'posicion-publicacion', 'numero-revistas', 'cuartil'];
  ...
  constructor(
    public readonly actionService: PublicacionActionService,
    ...
    this.formPart = this.fragment as PublicacionDatosGeneralesFragment;
  }
    ...
    this.indiceImpactoDataSource.sortingDataAccessor =
      (indiceImpacto: IIndiceImpacto, property: string) => {
        switch (property) {
          ...
          case 'valor':
            return indiceImpacto.indice;
          case 'posicion-publicacion':
            return indiceImpacto.posicionPublicacion;
          case 'numero-revistas':
            return indiceImpacto.numeroRevistas;
          case 'cuartil':
            return this.indiceImpactoTransformService.transformCuartil(indiceImpacto);
          default:
