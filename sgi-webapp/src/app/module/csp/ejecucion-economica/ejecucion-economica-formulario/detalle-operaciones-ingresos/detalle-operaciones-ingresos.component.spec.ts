...
import { DetalleOperacionesIngresosComponent } from './detalle-operaciones-ingresos.component';

describe('DetalleOperacionesIngresosComponent', () => {
  let component: DetalleOperacionesIngresosComponent;
  let fixture: ComponentFixture<DetalleOperacionesIngresosComponent>;
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      declarations: [DetalleOperacionesIngresosComponent],
      imports: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(DetalleOperacionesIngresosComponent);
