...
import { ValidacionGastosComponent } from './validacion-gastos.component';

describe('ValidacionGastosComponent', () => {
  let component: ValidacionGastosComponent;
  let fixture: ComponentFixture<ValidacionGastosComponent>;
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      declarations: [ValidacionGastosComponent],
      imports: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ValidacionGastosComponent);
