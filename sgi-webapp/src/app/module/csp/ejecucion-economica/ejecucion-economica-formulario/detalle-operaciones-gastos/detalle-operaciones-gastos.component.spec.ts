...
import { DetalleOperacionesGastosComponent } from './detalle-operaciones-gastos.component';

describe('DetalleOperacionesGastosComponent', () => {
  let component: DetalleOperacionesGastosComponent;
  let fixture: ComponentFixture<DetalleOperacionesGastosComponent>;
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      declarations: [DetalleOperacionesGastosComponent],
      imports: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(DetalleOperacionesGastosComponent);
