...
export interface SolicitudRrhhAcreditarCategoriaProfesionalModalData {
...
@Component({
  templateUrl: './solicitud-rrhh-acreditar-categoria-profesional-modal.component.html',
  styleUrls: ['./solicitud-rrhh-acreditar-categoria-profesional-modal.component.scss']
})
export class SolicitudRrhhAcreditarCategoriaProfesionalModalComponent
  extends DialogFormComponent<SolicitudRrhhAcreditarCategoriaProfesionalModalData>
  ...
  constructor(
    matDialogRef: MatDialogRef<SolicitudRrhhAcreditarCategoriaProfesionalModalComponent>,
    @Inject(MAT_DIALOG_DATA) public data: SolicitudRrhhAcreditarCategoriaProfesionalModalData,
