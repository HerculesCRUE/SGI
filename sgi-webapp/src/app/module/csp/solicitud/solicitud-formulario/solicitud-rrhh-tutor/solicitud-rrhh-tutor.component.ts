...
import { SolicitudRrhhTutorFragment } from './solicitud-rrhh-tutor.fragment';
...
@Component({
  selector: 'sgi-solicitud-rrhh-tutor',
  templateUrl: './solicitud-rrhh-tutor.component.html',
  styleUrls: ['./solicitud-rrhh-tutor.component.scss']
})
export class SolicitudRrhhTutorComponent extends FormFragmentComponent<ISolicitudRrhhTutor> implements OnInit {
  formPart: SolicitudRrhhTutorFragment;
  ...
  constructor(
    ...
    this.formPart = this.fragment as SolicitudRrhhTutorFragment;
  }
