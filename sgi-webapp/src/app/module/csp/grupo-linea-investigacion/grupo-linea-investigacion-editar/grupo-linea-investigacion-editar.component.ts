...
@Component({
  selector: 'sgi-grupo-linea-investigacion-editar',
  templateUrl: './grupo-linea-investigacion-editar.component.html',
  styleUrls: ['./grupo-linea-investigacion-editar.component.scss'],
  viewProviders: [
    GrupoLineaInvestigacionActionService
  ]
})
export class GrupoLineaInvestigacionEditarComponent extends ActionComponent implements OnInit {
