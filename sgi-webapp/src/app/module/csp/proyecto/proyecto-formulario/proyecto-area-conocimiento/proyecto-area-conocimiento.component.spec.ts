...
import { ProyectoAreaConocimientoComponent } from './proyecto-area-conocimiento.component';

describe('ProyectoAreaConocimientoComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      declarations: [ProyectoAreaConocimientoComponent],
      imports: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ProyectoAreaConocimientoComponent);
