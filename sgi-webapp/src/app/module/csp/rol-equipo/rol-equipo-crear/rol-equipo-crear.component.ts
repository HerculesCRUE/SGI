...
@Component({
  selector: 'sgi-rol-equipo-crear',
  templateUrl: './rol-equipo-crear.component.html',
  styleUrls: ['./rol-equipo-crear.component.scss'],
  viewProviders: [
    RolEquipoActionService
  ]
})
export class RolEquipoCrearComponent extends ActionComponent implements OnInit {
