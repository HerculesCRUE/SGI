...
import { NodeDocumentoSolicitud, SolicitudDocumentosPublicFragment } from './solicitud-documentos-public.fragment';
...
@Component({
  selector: 'sgi-solicitud-documentos-public',
  templateUrl: './solicitud-documentos-public.component.html',
  styleUrls: ['./solicitud-documentos-public.component.scss']
})
export class SolicitudDocumentosPublicComponent extends FragmentComponent implements OnInit, OnDestroy {
  VIEW_MODE = VIEW_MODE;

  formPart: SolicitudDocumentosPublicFragment;
  ...
  constructor(
    ...
    this.formPart = this.fragment as SolicitudDocumentosPublicFragment;
