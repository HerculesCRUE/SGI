...
export interface SolicitudRrhhAcreditarNivelAcademicoPublicModalData {
...
@Component({
  templateUrl: './solicitud-rrhh-acreditar-nivel-academico-public-modal.component.html',
  styleUrls: ['./solicitud-rrhh-acreditar-nivel-academico-public-modal.component.scss']
})
export class SolicitudRrhhAcreditarNivelAcademicoPublicModalComponent
  extends DialogFormComponent<SolicitudRrhhAcreditarNivelAcademicoPublicModalData>
  ...
  constructor(
    matDialogRef: MatDialogRef<SolicitudRrhhAcreditarNivelAcademicoPublicModalComponent>,
    @Inject(MAT_DIALOG_DATA) public data: SolicitudRrhhAcreditarNivelAcademicoPublicModalData,
  ...
  protected getValue(): SolicitudRrhhAcreditarNivelAcademicoPublicModalData {
