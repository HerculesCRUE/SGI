...
export class EmpresaExplotacionResultadosDatosGeneralesFragment extends FormFragment<IEmpresaExplotacionResultados> {
  ...
  protected buildFormGroup(): FormGroup {
    const formGroup = new FormGroup({
      ...
      objetoSocial: new FormControl(null, [Validators.required, Validators.maxLength(250)]),
      conocimientoTecnologia: new FormControl(null, [Validators.required, Validators.maxLength(250)]),
