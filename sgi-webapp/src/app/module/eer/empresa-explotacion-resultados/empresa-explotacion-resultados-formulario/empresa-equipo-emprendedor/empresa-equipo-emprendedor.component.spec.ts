...
import { EmpresaEquipoEmprendedorComponent } from './empresa-equipo-emprendedor.component';

describe('EmpresaEquipoEmprendedorComponent', () => {
  let component: EmpresaEquipoEmprendedorComponent;
  let fixture: ComponentFixture<EmpresaEquipoEmprendedorComponent>;
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      declarations: [EmpresaEquipoEmprendedorComponent],
      imports: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(EmpresaEquipoEmprendedorComponent);
