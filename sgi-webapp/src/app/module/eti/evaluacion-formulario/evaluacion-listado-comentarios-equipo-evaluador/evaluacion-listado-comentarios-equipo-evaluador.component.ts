...
@Component({
  selector: 'sgi-evaluacion-listado-comentarios-equipo-evaluador',
  templateUrl: './evaluacion-listado-comentarios-equipo-evaluador.component.html',
  styleUrls: ['./evaluacion-listado-comentarios-equipo-evaluador.component.scss']
})
export class EvaluacionListadoComentariosEquipoEvaluadorComponent extends AbstractTableWithoutPaginationComponent<IEvaluadorWithComentariosAndEnviados> {
