...
@Component({
  selector: 'sgi-file-upload-public',
  templateUrl: './file-upload-public.component.html',
  styleUrls: ['./file-upload-public.component.scss'],
  ...
  providers: [
    {
      ...
      useExisting: SgiFileUploadPublicComponent
    }
  ],
})
export class SgiFileUploadPublicComponent implements
