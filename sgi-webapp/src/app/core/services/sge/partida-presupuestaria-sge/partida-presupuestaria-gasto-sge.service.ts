...
export class PartidaPresupuestariaGastoSgeService extends PartidaPresupuestariaSgeServiceMixinBase {

  private static readonly MAPPING = '/partidas-presupuestarias-gastos';

  constructor(protected http: HttpClient) {
    super(
      `${environment.serviceServers.sge}${PartidaPresupuestariaGastoSgeService.MAPPING}`,
      http
    );
  }
