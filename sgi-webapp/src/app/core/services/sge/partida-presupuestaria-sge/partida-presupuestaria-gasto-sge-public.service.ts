...
export class PartidaPresupuestariaGastoSgePublicService extends PartidaPresupuestariaSgeServiceMixinBase {

  private static readonly MAPPING = '/partidas-presupuestarias-gastos';
  private static readonly PUBLIC_PREFIX = '/public';

  constructor(protected http: HttpClient) {
    super(
      `${environment.serviceServers.sge}${PartidaPresupuestariaGastoSgePublicService.PUBLIC_PREFIX}${PartidaPresupuestariaGastoSgePublicService.MAPPING}`,
      http
    );
  }
