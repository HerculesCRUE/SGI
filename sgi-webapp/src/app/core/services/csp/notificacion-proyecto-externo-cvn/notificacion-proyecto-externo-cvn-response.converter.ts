...
class INotificacionProyectoExternoCVNResponseConverter
  extends SgiBaseConverter<INotificacionProyectoExternoCVNResponse, INotificacionProyectoExternoCVN> {
  toTarget(value: INotificacionProyectoExternoCVNResponse): INotificacionProyectoExternoCVN {
    if (!value) {
  ...
  fromTarget(value: INotificacionProyectoExternoCVN): INotificacionProyectoExternoCVNResponse {
    if (!value) {
      return value as unknown as INotificacionProyectoExternoCVNResponse;
    }
    return {
      id: value.id,
      titulo: value.titulo,
...
export const NOTIFICACION_PROYECTO_EXTERNO_CVN_RESPONSE_CONVERTER = new INotificacionProyectoExternoCVNResponseConverter();
