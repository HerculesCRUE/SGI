...
-- INFORME
INSERT INTO eti.informe (id, memoria_id, documento_ref, version, tipo_evaluacion_id) VALUES (1, 2, 'DocumentoFormulario1', 1, 1);
...
ALTER SEQUENCE eti.informe_seq RESTART WITH 9;