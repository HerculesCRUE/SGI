CREATE OR REPLACE FUNCTION ${schemaPrefix}REMOVE_ACCENTS (p_clob IN CLOB) RETURN CLOB IS
v_offset NUMBER := 1;
...
LOOP
  ...
  -- Convertir el fragmento a mayúsculas y eliminar acentos
  v_sub_clob := UPPER(TRANSLATE(v_sub_clob,
