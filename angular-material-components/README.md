# SGI fork of [https://github.com/h2qutc/angular-material-components](https://github.com/h2qutc/angular-material-components)
This is a fork to provide support for inmutable objects until original repository accept the pull request that add support.
