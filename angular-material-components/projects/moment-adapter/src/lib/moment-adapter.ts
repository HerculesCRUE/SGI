...
export class NgxMatMomentAdapter extends NgxMatDateAdapter<Moment> {
  ...
  setHour(date: _moment.Moment, value: number): Moment {
    return date.hours(value);
  }
  setMinute(date: _moment.Moment, value: number): Moment {
    return date.minutes(value)
  }
  setSecond(date: _moment.Moment, value: number): Moment {
    return date.seconds(value);
  }
