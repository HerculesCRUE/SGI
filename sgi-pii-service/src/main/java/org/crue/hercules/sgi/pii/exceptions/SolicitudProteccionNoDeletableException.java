...
public class SolicitudProteccionNoDeletableException extends ProblemException {

  public SolicitudProteccionNoDeletableException(Long id) {
    super(Problem.builder().type(ProblemExceptionHandler.VALIDATION_PROBLEM_TYPE)
        ...
        .detail(ProblemMessage.builder().key(SolicitudProteccionNoDeletableException.class)
            .parameter("id", id)
            .build())
