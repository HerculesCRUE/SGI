...
import org.crue.hercules.sgi.pii.model.Identifiable;
import org.crue.hercules.sgi.pii.repository.ActivableRepository;
    ...
    if (repositoryClass == void.class) {
      try {
        repositoryClass = Class
            .forName("org.crue.hercules.sgi.pii.repository.".concat(entityClass.getSimpleName()).concat("Repository"));
