...
public class InvencionPalabraClaveNotFoundException extends PiiNotFoundException {
  /**
  *
  */
  private static final long serialVersionUID = 1L;

  public InvencionPalabraClaveNotFoundException(Long invencionPalabraClaveId) {
    super(ProblemMessage.builder().key(PiiNotFoundException.class)
        .parameter("entity", ApplicationContextSupport.getMessage(
            InvencionPalabraClave.class))
        .parameter("id",
            invencionPalabraClaveId)
        .build());
  }
}
